...
export default function MobileNav() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-50 bg-black flex flex-col px-6 transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="shrink-0 pb-10">
          <button
            className="bg-white text-black text-[14px] font-medium tracking-[-0.56px] px-6 py-3 rounded-[24px]"
            onClick={() => setOpen(false)}
          >
            Let&apos;s talk
          </button>
